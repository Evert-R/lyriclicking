...
function pushCurrentLine(position, index) {
    ...
    if (index == 0) {
        $('#er-control-previous').removeClass('er-control-yellow');
        $('#er-control-previous').removeClass('er-hover-yellow');
    }
    if (index > 0) {
        $('#er-control-previous').addClass('er-control-yellow');
        $('#er-control-previous').addClass('er-hover-yellow');
    }
    if (index == jsLyricKeys.length - 1) {
        $('#er-control-next').removeClass('er-control-yellow');
        $('#er-control-next').removeClass('er-hover-yellow');
    }
    if (index < jsLyricKeys.length - 1) {
        $('#er-control-next').addClass('er-control-yellow');
...
wavesurfer.on('ready', function () {
    ...
    $('#er-control-forward').on('click', function () {
        $('#er-control-backward').addClass('er-control-purple');
...
function pushInitialMode() {
    ...
    $('#er-control-stop').addClass('er-control-blink');

    $('#er-control-backward').removeClass('er-control-purple');
    $('#er-control-backward').removeClass('er-hover-purple');
    $('#er-control-forward').addClass('er-control-purple');
...
function pushPlayMode() {
    ...
    $('#er-control-stop').removeClass('er-control-blink');
